...
### New Features
- Add `show` to `_render_plotly` and `_render_bokeh` to toggle off in save-only cases ([#TBD](https://github.com/NatLabRockies/ampworks/pull/TBD))
...
### Chores
- Prepare for re-write of `_core` by adding `_core/_backend` submodule, with tests ([#38](https://github.com/NatLabRockies/ampworks/pull/38))
